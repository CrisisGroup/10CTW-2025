var config = {
  style: "mapbox://styles/daltonwb/cm5mxh9k100c701pl0qjsa7kd",
  accessToken:
  ...
  chapters: [
    {
      ...
      image: "",
      description:
        "In unsettled times, Donald Trump’s return to the White House looks set to shake things up further. Here are the International Crisis Group’s Ten Conflicts to Watch in 2025." + "<div class='spacer'></div>" + "<strong style='color: #a4343a;'>Rotate the globe by clicking and dragging your pointer, or use the controls in the top right.</strong>" +
        "<div class='spacer'></div>" + "<strong style='color: #a4343a;'>Or scroll down to continue. &#8595;</strong>",
      location: {
